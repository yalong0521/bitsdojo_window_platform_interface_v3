...
class NotImplementedWindow extends DesktopWindow {
  ...
  @override
  set titleBarButtonSize(Size size) {
    throw UnimplementedError(
        'titleBarButtonSize setter has not been implemented.');
  }

  @override
  set titleBarHeight(double height) {
    throw UnimplementedError('titleBarHeight setter has not been implemented.');
  }
}
